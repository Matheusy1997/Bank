            ...
            { 
                case "Business":
                    ...
                    while (true)
                    {
                        ...
                        if (resultado == null)
                        {
                            listAccount.Add(new BusinessAccount(nameAccount.Trim().ToUpper(), numberAccount, 500.00));
                            break;
                        }
                        break;                       
                    }
                ...
                case "Savings":
                    ...
                    while (true) {
                        ...
                        if (resultado == null)
                        {
                            listAccount.Add(new SavingAccount(nameAccount.Trim().ToUpper(), numberAccount));
                            break;
                        }
                        break;
                    }
